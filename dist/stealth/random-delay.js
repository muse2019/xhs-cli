...
export class RequestCooldown {
    ...
    static MIN_INTERVAL_MS = 800; // 最小请求间隔
    static MAX_INTERVAL_MS = 3000; // 最大请求间隔
    static BURST_THRESHOLD = 5; // 突发阈值
    static COOLDOWN_MULTIPLIER = 2; // 冷却倍数
    /**
     * 等待冷却后才能继续请求
     */
...
export class BehaviorThrottler {
    ...
    static WINDOW_MS = 60000; // 1分钟窗口
    static MAX_OPERATIONS = 30; // 每分钟最大操作数
    /**
     * 检查是否应该节流
     */
